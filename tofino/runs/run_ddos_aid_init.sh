...
#../../p4_build_albert.sh --with-p4c="/data/bf-sde-9.5.0/install/bin/bf-p4c" p4src/ddos_aid_init.p4
...
tmux send-keys -t tofino '/home/nsg/albert/run_switchd.sh -p ddos_aid_init' Enter
...
tmux send-keys -t tofino '. /data/set_sde_9.5.0.sh' Enter
tmux send-keys -t tofino '/home/nsg/albert/run_bfshell.sh -b ~/albert/ddos-aid/tofino/bfrt/ddos_aid_init_cp_setup.py' Enter

# Add a new window pane for the pd-rpc
tmux split-window -h -p 66
tmux select-pane -t 3
tmux send-keys -t tofino '. /data/set_sde_9.5.0.sh' Enter
tmux send-keys -t tofino '/home/nsg/albert/run_pd_rpc.py ~/albert/ddos-aid/tofino/pd_rpc/priority_queueing.py' Enter
...
tmux send-keys -t tofino 'python ddos_aid_init_controller.py'
