...
function master(args)
	...
	device.waitForLinks()
        ...
        mg.startTask("launch_attack", dev:getTxQueue(1), packetSize, flows, "1.1.1.1")
        mg.startTask("launch_attack", dev:getTxQueue(2), packetSize, flows, "1.1.1.200")
        mg.startTask("launch_attack", dev:getTxQueue(3), packetSize, flows, "1.1.200.1")
        mg.startTask("launch_attack", dev:getTxQueue(4), packetSize, flows, "1.1.200.200")
...
function launch_attack(queue, size, flows, ip)
