...
tmux send-keys -t tofino '. /data/set_sde_9.5.0.sh' Enter
tmux send-keys -t tofino '/home/nsg/albert/run_bfshell.sh -b ~/albert/ddos-aid/tofino/bfrt/simple_forwarder_cp_setup.py carpetbombing' Enter
...
tmux send-keys -t tofino 'python simple_forwarder_controller.py carpetbombing'
