...
sudo ../../p4_build_albert.sh --with-p4c="/data/bf-sde-9.5.0/install/bin/bf-p4c" p4src/accturbo.p4
...
tmux send-keys -t tofino '../../run_switchd.sh -p accturbo' Enter
...
tmux send-keys -t tofino 'python accturbo_controller.py'
