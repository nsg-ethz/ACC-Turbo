...
plot "analysis/throughput_malicious.dat" using 1:2 title "Output Attack" w l ls 1 lw 4, \
     "analysis/throughput_benign.dat" using 1:2 title "Output Benign" w l ls 7 lw 4