...
public class MainFromProperties {
    ...
    public static void main(String args[]) {
        ...
        // DDoS: In our case, we just need to generate one flow from 1 to 2
    ...
    private static void planTraffic(long runtimeNs, Map<Integer, TransportLayer> idToTransportLayer) {
        ...
        // Registro el unic flow qe tindrem de manera hardcoded

        // Aixi es com estava abans
        ...
        //..
        // Aixi es la pirula qe fem. Register the flow from [srcId] to [dstId].
        long time = 0;
        int srcId = 0;
        int dstId = 1;
        long flowSizeByte = 10000; // I think it does not matter

        // Create event
        FlowStartEvent event = new FlowStartEvent(time, idToTransportLayer.get(srcId), dstId, flowSizeByte);
