...
echo -e "Running ACC-Turbo Figure 9a evaluation using run_fig_9a.sh"


#########################################
# Fig 9a: Individual attacks
#########################################
