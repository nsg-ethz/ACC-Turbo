...
if __name__ == "__main__":
    ...
    # Call analysis functions
    for ptarget in [1, 2, 3, 4, 5, 6]:

        analyze_throughput('temp/accr/acc_misconfiguration_ptarget/ptarget0{}/aggregate_input_throughput.csv.log'.format(ptarget),
                           'projects/accr/analysis/acc_misconfiguration_ptarget/ptarget0{}/aggregate_input_throughput.dat'.format(ptarget),
                           "input", 0, 50)

        analyze_throughput('temp/accr/acc_misconfiguration_ptarget/ptarget0{}/aggregate_output_throughput.csv.log'.format(ptarget),
                           'projects/accr/analysis/acc_misconfiguration_ptarget/ptarget0{}/aggregate_output_throughput.dat'.format(ptarget), "output", 0, 50)

        analyze_total_throughput('temp/accr/acc_misconfiguration_ptarget/ptarget0{}/aggregate_drops.csv.log'.format(ptarget),
                                 'projects/accr/analysis/acc_misconfiguration_ptarget/ptarget0{}/aggregate_total_drops.dat'.format(ptarget), 0, 50)

        analyze_drop_rate('projects/accr/analysis/acc_misconfiguration_ptarget/ptarget0{}/aggregate_input_throughput.dat'.format(ptarget),
                          'projects/accr/analysis/acc_misconfiguration_ptarget/ptarget0{}/aggregate_total_drops.dat'.format(ptarget),
                          'projects/accr/analysis/acc_misconfiguration_ptarget/ptarget0{}/aggregate_droprate.dat'.format(ptarget),
                          0, 50)