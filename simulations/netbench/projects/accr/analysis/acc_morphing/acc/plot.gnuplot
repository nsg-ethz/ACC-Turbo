...
set output "projects/accr/analysis/acc_morphing/acc/input_aggregate.pdf"
plot "projects/accr/analysis/acc_morphing/acc/aggregate_input_throughput.dat" using 1:2 title "Agg. 1" w l ls 6 lw 4, \
...
set output "projects/accr/analysis/acc_morphing/acc/output_aggregate.pdf"
plot "projects/accr/analysis/acc_morphing/acc/aggregate_output_throughput.dat" using 1:2 title "Agg. 1" w l ls 6 lw 4, \
'' using 1:3 title "Agg. 2" w l ls 5 lw 4, \
'' using 1:4 title "Agg. 3" w l ls 4 lw 4, \
'' using 1:5 title "Agg. 4" w l ls 3 lw 4, \
'' using 1:6 title "Agg. 5" w l ls 1 lw 4, \
...
set yrange [-0.1:1]
set ytics ("0" 0, "0.2" 0.2, "0.4" 0.4, "0.6" 0.6, "0.8" 0.8, "1" 1)
set output "projects/accr/analysis/acc_morphing/acc/droprate_aggregate.pdf"
plot "projects/accr/analysis/acc_morphing/acc/aggregate_droprate.dat" using 1:2 title "" w l ls 8 lw 4