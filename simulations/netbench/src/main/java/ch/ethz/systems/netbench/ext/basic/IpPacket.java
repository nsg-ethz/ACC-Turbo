...
public abstract class IpPacket extends Packet implements IpHeader {
     ...
     */
    public IpPacket(long flowId, long payloadSizeBit, int sourceId, int destinationId, int TTL, boolean isTCP) {
        super(flowId, IP_HEADER_SIZE_BIT + payloadSizeBit, isTCP);
