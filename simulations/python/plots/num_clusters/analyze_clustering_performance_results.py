...
if __name__ == '__main__':
    ...
    if len(sys.argv) != 2: 
        ...
        if (sys.argv[1] == "numclusters"):
            ...
            ###################
            # Num clusters. Normalization effects
            ###################

            output_file_normalization_numclusters_purity = open('plot_normalization_numclusters_purity.dat', 'w')
            output_file_normalization_numclusters_recall_benign = open('plot_normalization_numclusters_recall_benign.dat', 'w')
            output_file_normalization_numclusters_recall_malicious = open('plot_normalization_numclusters_recall_malicious.dat', 'w')

            # We initialize the file
            output_file_normalization_numclusters_purity.write("#    Range_Exhaustive    Range_Exhaustive_Normalized    Range_Exhaustive    Range_Fast    Range_Fast_Normalized    Range_Fast    Representative_Exhaustive    Representative_Exhaustive_Normalized    Representative_Exhaustive    Representative_Fast    Representative_Fast_Normalized    Representative_Fast\n")
            output_file_normalization_numclusters_recall_benign.write("#    Range_Exhaustive    Range_Exhaustive_Normalized    Range_Exhaustive    Range_Fast    Range_Fast_Normalized    Range_Fast    Representative_Exhaustive    Representative_Exhaustive_Normalized    Representative_Exhaustive    Representative_Fast    Representative_Fast_Normalized    Representative_Fast\n")
            output_file_normalization_numclusters_recall_malicious.write("#    Range_Exhaustive    Range_Exhaustive_Normalized    Range_Exhaustive    Range_Fast    Range_Fast_Normalized    Range_Fast    Representative_Exhaustive    Representative_Exhaustive_Normalized    Representative_Exhaustive    Representative_Fast    Representative_Fast_Normalized    Representative_Fast\n")
            ...
            for num_clusters in range(2,11,2): # num_clusters = 2,4,6,8,10
                ...
                average_purity_range_exhaustive_normalized = ""
                average_purity_range_fast_normalized = ""
                average_purity_representative_exhaustive_normalized = ""
                average_purity_representative_fast_normalized = ""

                average_recall_benign_range_exhaustive_normalized = ""
                average_recall_benign_range_fast_normalized = "" 
                average_recall_benign_representative_exhaustive_normalized = ""
                average_recall_benign_representative_fast_normalized = ""

                average_recall_malicious_range_exhaustive_normalized = ""
                average_recall_malicious_range_fast_normalized = ""
                average_recall_malicious_representative_exhaustive_normalized = ""
                average_recall_malicious_representative_fast_normalized = ""     

                input_file = open('clustering_performance_logs.dat', 'r')
                for line in input_file.readlines():
                    # Not normalized
                    if ("Online_Range_Exhaustive_" + str(num_clusters) + "_1_0.3_False_1_len_id_frag_offset_ttl_proto_src0_src1_src2_src3_dst0_dst1_dst2_dst3_sport_dport") in line:
                        average_purity_range_exhaustive = line.split(",")[1]
                        average_recall_benign_range_exhaustive = line.split(",")[4]
                        average_recall_malicious_range_exhaustive = line.split(",")[5].split("\n")[0]
            
                    elif ("Online_Range_Fast_" + str(num_clusters) + "_1_0.3_False_1_len_id_frag_offset_ttl_proto_src0_src1_src2_src3_dst0_dst1_dst2_dst3_sport_dport") in line:
                        average_purity_range_fast = line.split(",")[1]
                        average_recall_benign_range_fast = line.split(",")[4]
                        average_recall_malicious_range_fast = line.split(",")[5].split("\n")[0]                
            
                    elif ("Online_Representative_Exhaustive_" + str(num_clusters) + "_1_0.3_False_1_len_id_frag_offset_ttl_proto_src0_src1_src2_src3_dst0_dst1_dst2_dst3_sport_dport") in line:
                        average_purity_representative_exhaustive = line.split(",")[1]
                        average_recall_benign_representative_exhaustive = line.split(",")[4]
                        average_recall_malicious_representative_exhaustive = line.split(",")[5].split("\n")[0]              
            
                    elif ("Online_Representative_Fast_" + str(num_clusters) + "_1_0.3_False_1_len_id_frag_offset_ttl_proto_src0_src1_src2_src3_dst0_dst1_dst2_dst3_sport_dport") in line:
                        average_purity_representative_fast = line.split(",")[1]
                        average_recall_benign_representative_fast = line.split(",")[4]
                        average_recall_malicious_representative_fast = line.split(",")[5].split("\n")[0]      

                    # Normalized
                    elif ("Online_Range_Exhaustive_" + str(num_clusters) + "_1_0.3_True_1_len_id_frag_offset_ttl_proto_src0_src1_src2_src3_dst0_dst1_dst2_dst3_sport_dport") in line:
                        average_purity_range_exhaustive_normalized = line.split(",")[1]
                        average_recall_benign_range_exhaustive_normalized = line.split(",")[4]
                        average_recall_malicious_range_exhaustive_normalized = line.split(",")[5].split("\n")[0]
            
                    elif ("Online_Range_Fast_" + str(num_clusters) + "_1_0.3_True_1_len_id_frag_offset_ttl_proto_src0_src1_src2_src3_dst0_dst1_dst2_dst3_sport_dport") in line:
                        average_purity_range_fast_normalized = line.split(",")[1]
                        average_recall_benign_range_fast_normalized = line.split(",")[4]
                        average_recall_malicious_range_fast_normalized = line.split(",")[5].split("\n")[0]                
            
                    elif ("Online_Representative_Exhaustive_" + str(num_clusters) + "_1_0.3_True_1_len_id_frag_offset_ttl_proto_src0_src1_src2_src3_dst0_dst1_dst2_dst3_sport_dport") in line:
                        average_purity_representative_exhaustive_normalized = line.split(",")[1]
                        average_recall_benign_representative_exhaustive_normalized = line.split(",")[4]
                        average_recall_malicious_representative_exhaustive_normalized = line.split(",")[5].split("\n")[0]              
            
                    elif ("Online_Representative_Fast_" + str(num_clusters) + "_1_0.3_True_1_len_id_frag_offset_ttl_proto_src0_src1_src2_src3_dst0_dst1_dst2_dst3_sport_dport") in line:
                        average_purity_representative_fast_normalized = line.split(",")[1]
                        average_recall_benign_representative_fast_normalized = line.split(",")[4]
                        average_recall_malicious_representative_fast_normalized = line.split(",")[5].split("\n")[0]    

                output_file_normalization_numclusters_purity.write(str(num_clusters) + "    " + average_purity_range_exhaustive + "    " + average_purity_range_exhaustive_normalized + "    " + average_purity_range_exhaustive + "    " + average_purity_range_fast + "    " + average_purity_range_fast_normalized + "    " + average_purity_range_fast + "    " + average_purity_representative_exhaustive + "    " + average_purity_representative_exhaustive_normalized + "    " + average_purity_representative_exhaustive + "    " + average_purity_representative_fast + "    " + average_purity_representative_fast_normalized + "    " + average_purity_representative_fast + "\n")
                output_file_normalization_numclusters_recall_benign.write(str(num_clusters) + "    " + average_recall_benign_range_exhaustive + "    " + average_recall_benign_range_exhaustive_normalized + "    " + average_recall_benign_range_exhaustive + "    " + average_recall_benign_range_fast + "    " + average_recall_benign_range_fast_normalized + "    " + average_recall_benign_range_fast + "    " + average_recall_benign_representative_exhaustive + "    " + average_recall_benign_representative_exhaustive_normalized + "    " + average_recall_benign_representative_exhaustive + "    " + average_recall_benign_representative_fast + "    " + average_recall_benign_representative_fast_normalized + "    " + average_recall_benign_representative_fast + "\n")
                output_file_normalization_numclusters_recall_malicious.write(str(num_clusters) + "    " + average_recall_malicious_range_exhaustive + "    " + average_recall_malicious_range_exhaustive_normalized + "    " + average_recall_malicious_range_exhaustive + "    " + average_recall_malicious_range_fast + "    " + average_recall_malicious_range_fast_normalized + "    " + average_recall_malicious_range_fast + "    " + average_recall_malicious_representative_exhaustive + "    " + average_recall_malicious_representative_exhaustive_normalized + "    " + average_recall_malicious_representative_exhaustive + "    " + average_recall_malicious_representative_fast + "    " + average_recall_malicious_representative_fast_normalized + "    " + average_recall_malicious_representative_fast + "\n")
                input_file.close()

            output_file_normalization_numclusters_purity.close()
            output_file_normalization_numclusters_recall_benign.close()
            output_file_normalization_numclusters_recall_malicious.close()
