...
if __name__ == '__main__':  # Main: Uses SCAPY to read pcap, DPKT to write
    ...
    w = open("caida_2018_equinix_results/ip_dst.dat", 'w')
    ...
    w = open("caida_2018_equinix_results/t_ports.dat", 'w')
