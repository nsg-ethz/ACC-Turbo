...
set xrange [0:15]
plot "sport.dat" using 2:xtic(1) ls 6 lw 2 title "Number of flows"

# Destination-port histogram
set xlabel "Top 15 ports"
set output "histogram_dport.pdf"
set xrange [0:15]
plot "dport.dat" using 2:xtic(1) ls 6 lw 2 title "Number of flows"

# Source-address histogram
set xlabel "Top 15 addresses"
set output "histogram_saddr.pdf"
set xrange [0:15]
plot "saddr.dat" using 2:xtic(1) ls 6 lw 2 title "Number of flows"

# Destination-address histogram
set xlabel "Top 15 addresses"
set output "histogram_daddr.pdf"
set xrange [0:15]
plot "daddr.dat" using 2:xtic(1) ls 6 lw 2 title "Number of flows"

# Max-packet-length histogram
set xlabel "Top 15 max. packet lengths"
set output "histogram_max_packet_length.pdf"
set xrange [0:15]
plot "max_packet_length.dat" using 2:xtic(1) ls 6 lw 2 title "Number of flows"

# Protocol histogram
set xlabel "Protocol numbers"
set output "histogram_proto.pdf"
set xrange [0:10]
plot "proto.dat" using 2:xtic(1) ls 6 lw 2 title "Number of flows"